...
prompt_type_list = ['DQ','JQ','JQ+COT','JQ+MC','JQ+COT+VI+KA', 'JQ+COT+RL+KA']
...
def get_prompt_from_type(prompt_type,name,user_prompt, assistant_prompt,domain,input_msg,input_msg_cot_vi_ka, input_msg_cot_rl_ka):
    ...
    if  prompt_type == 'JQ+COT+VI+KA':
        
        return cot_msg_vi_ka
    elif prompt_type == 'JQ+COT+RL+KA':
    ...
    for i, e in enumerate(email_list):
        ...
        if(prompt_type == 'JQ' or prompt_type == 'JQ+MC'):
            ...
            for i_msg in range(num_msg):
                ...
                final_res = chat_with_backoff(context)
        ...
        elif(prompt_type == 'DQ' or prompt_type == 'JQ+COT' or prompt_type == 'JQ+COT+VI+KA' or prompt_type == 'JQ+COT+RL+KA'):
        ...
        if('MC' in prompt_type):
            ...
            if(not mc_msg):
                ...
                mc_res = chat_with_backoff(mc_msg)
...
if __name__ == '__main__':
    ...
    for p in ['JQ+COT+VI+KA', 'JQ+COT+RL+KA']:
        print(f'----:{p}')
